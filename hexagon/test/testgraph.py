...
subprocess.call("qnn-onnx-converter -i test_wkv.onnx --op_package_config ../RwkvWkvOpPackage.xml", stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL, shell=True)
...
subprocess.call("qnn-onnx-converter -i test_wkv_chunk.onnx --op_package_config ../RwkvWkvOpPackage.xml", stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL, shell=True)
