...
subprocess.call("qnn-onnx-converter -i test_wkv.onnx --op_package_config ../RwkvWkvOpPackageHTP.xml", stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL, shell=True)
...
subprocess.call("qnn-model-lib-generator -c test_wkv.cpp -b test_wkv.bin -t x86_64-linux-clang", stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL, shell=True)
print("executing qnn-net-run")
subprocess.call("qnn-net-run --input_list input_list_wkv.txt --model lib/x86_64-linux-clang/libtest_wkv.so --backend /opt/qcom/aistack/qairt/2.26.0.240828/lib/x86_64-linux-clang/libQnnHtp.so --op_packages ../HTP/RwkvWkvOpPackage/build/x86_64-linux-clang/libQnnRwkvWkvOpPackage.so:RwkvWkvOpPackageInterfaceProvider", stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL, shell=True)
...
subprocess.call("qnn-onnx-converter -i test_wkv_chunk.onnx --op_package_config ../RwkvWkvOpPackageHTP.xml", stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL, shell=True)
...
with open("input_list_wkv_chunk.txt", "w") as f:
    f.writelines(input_list_lines)
print("generating qnn model lib")
subprocess.call("qnn-model-lib-generator -c test_wkv_chunk.cpp -b test_wkv_chunk.bin -t x86_64-linux-clang", stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL, shell=True)
print("executing qnn-net-run")
subprocess.call("qnn-net-run --input_list input_list_wkv_chunk.txt --model lib/x86_64-linux-clang/libtest_wkv_chunk.so --backend /opt/qcom/aistack/qairt/2.26.0.240828/lib/x86_64-linux-clang/libQnnHtp.so --op_packages ../HTP/RwkvWkvOpPackage/build/x86_64-linux-clang/libQnnRwkvWkvOpPackage.so:RwkvWkvOpPackageInterfaceProvider", stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL, shell=True)
